...
SUBHEAD_LIST = {
    ...
    "ELECT/TRO": ["LOCO DEFECTS", "Tower Wagon", "Track Machine", "RUNNING ROOM DEFICIENCIES", "LOBBY DEFICIENCIES", "MISC"],
    ...
    "ENGINEERING": ["IOW WORKS (Other)", "IOW WORKS (Safety Related)", "PWI (Rough Riding, Track needs attention, any track related)"],
